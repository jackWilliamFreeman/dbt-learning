...
WITH levels AS (
	SELECT
		...
		COALESCE(TUL6.TIMEUSAGELEVELNAME, TUL5.TIMEUSAGELEVELNAME, TUL4.TIMEUSAGELEVELNAME, TUL3.TIMEUSAGELEVELNAME, TUL2.TIMEUSAGELEVELNAME, TUL1.TIMEUSAGELEVELNAME) LEAF_NAME
	FROM
...
SELECT
		...
		C.L5,
		C.L6,
		C.LEAF_NAME as LOWEST_LEVEL_NAME,
		ET.EVENTTYPENAME,
